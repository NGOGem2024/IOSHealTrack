...
type EditTherapyPlanScreenProps = NativeStackScreenProps<RootStackParamList, 'EditTherapyPlan'>;
...
const InputField: React.FC<InputFieldProps> = ({ icon, placeholder, value, onChangeText }) => (
  <View style={styles.inputContainer}>
    {icon}
    <TextInput
      style={styles.input}
